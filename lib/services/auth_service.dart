...
class AuthService {
  ...
  Future<UserCredential?> signInWithEmailAndPassword(
    ...
    try {
      ...
      if (kDebugMode) {
        print(
          'AuthService: FirebaseAuthException during sign in: ${e.code} - ${e.message}',
        );
      }
  ...
  Future<UserCredential?> createUserWithEmailAndPassword(
    ...
    try {
      ...
      if (kDebugMode) {
        print(
          'AuthService: FirebaseAuthException during registration: ${e.code} - ${e.message}',
        );
      }
      rethrow;
    } catch (e) {
  ...
  Future<void> signOut() async {
    try {
      if (kDebugMode) {
        print(
          'AuthService: Attempting to sign out user: ${currentUser?.email}',
        );
      }
      ...
      if (kDebugMode) {
        print(
          'AuthService: FirebaseAuthException during sign out: ${e.code} - ${e.message}',
        );
      }
      rethrow;
    } catch (e) {
